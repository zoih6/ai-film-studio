...
احفظ في `state/continuity-bible.md` بشكل دائم. كل prompt يأخذ منه Identity String.
...
احفظ في `state/frame-chain.md`. مثال:
...
احفظ في `state/continuity-bible.md` و`templates/01-production-blueprint.md`.

### 6.2 — Frame Chain

احفظ في `state/frame-chain.md`.

### 6.3 — Image Anchors

احفظ الوصف في `state/asset-registry.md` (يُنفَّذ من قبل 30-executive-producer).
...
- **STATE UPDATE**: `state/continuity-bible.md` + `state/frame-chain.md` + `state/asset-registry.md`
