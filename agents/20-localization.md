...
| M11 | توطين الطباعة العربية داخل الصور |
| M13 | إعداد التسليم بالعربية للمستخدم |
...
- وثّق الافتراض في `state/decision-log.md`
...
- **STATE UPDATE**: حقل `localization_log` في `state/decision-log.md`
...
- [ ] تم توثيق القرارات الثقافية في `state/decision-log.md`
