...
## Model Profiles
لا تثق بأي مواصفة رقمية قديمة من الذاكرة. استخدم `references/model-matrix.md` كمصدر داخلي، واعتبر بيانات Preview قابلة للتغير. عند وجود عدم يقين، لا تخترع capability.
