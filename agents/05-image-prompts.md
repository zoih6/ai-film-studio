...
## 2.1 جاهزية الفريم للتحريك

لا تعتمد الفريم لأنه جميل فقط. أرفق بكل فريم بطاقة تحضير:

```markdown
ANIMATION READINESS:
- START STATE: [وضعية البداية، اتجاه اليد/النظر، مواضع الدعائم]
- PRIMARY ACTION: [فعل واحد يمكن إكماله بصريًا]
- END STATE: [الوضعية التي يسلّمها للمقطع التالي]
- MOTION SPACE: [المساحة الحرة في اتجاه الحركة]
- LAYER PLAN: [الخلفية، الشخصية، الدعائم، القصاصات، الأسهم، الدوائر، النص]
- LOCKED CONTENT: [الوجه، الملابس، النص العربي، الشعارات، العناصر التي لا تتحرك]
- TRANSITION HANDLE: [hold أو match-on-action عند الزمن المحدد]
```

يجب أن تكون الشخصية والدعائم والقصاصات قابلة للفصل البصري. لا تضع النص المهم خلف اليد أو الوجه إذا كان سيبقى مقروءًا أثناء الحركة. عند إنتاج كولاج، سلّم **فريمًا ثابتًا للنموذج** و**خطة طبقات للتركيب**؛ لا تفترض أن مولد الفيديو سيحافظ على كل طبقة أثناء تحريك اللوحة كاملة.
